...
class Customer:
    ...
    daily_spend = None, max_weekly_spend = None, customer_id = None):
        self.customer_name = customer_name
        self.address = address
        self.contact = contact
        self.balance = balance
        self.account_type = account_type if account_type is not None else 1 # 1 shows its standard account any other value is savings account
        ...
        self.daily_spend = daily_spend if daily_spend is not None else None
    ...
    def __repr__(self) -> str:
        return f"({self.customer_name}, {self.address}, {self.contact}, {self.balance}, {self.account_type}, {self.date_created}, {self.max_w}, {self.daily_spend}, {self.max_weekly_spend},{self.customer_id})"

...
class Customer:
    def __init__(self, customer_name, address, contact, balance, account_type=None, date_created=None, customer_id=None):
    ...
    def __repr__(self) -> str:
        return f"({self.customer_name}, {self.address}, {self.contact}, {self.balance}, {self.account_type}, {self.date_created}, {self.position}, {self.customer_id})"
